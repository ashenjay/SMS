            ...
            <div class="left-content">
                <div class="inner-content">
                    ...
                    <div class="outter-wp" id="containerDiv">
                            ...
                            <table border="0" width='100%'>
                                <tbody>
                                    <tr>
                                        ...
                                        <td><h3> <img src="images/icon/Engineering-96.png" width="50" height="50" >Brand Master</h3><hr></td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="row">
                            <form name="form1" method="post" action="brandMaster.php">
                                <table width="50%" border="0">
                                    <tr>
                                        <td width="50%" align="right">Brand</td>
        ...
        '" . $_POST['status'] . "'); ";
                        ...
                        <div class="row">
                            <table width="100%" border="1">
                                <tr>
                                    <td width="31%"><strong>Brand Name</strong></td>
